...
from ...models.global_search_params_dto import GlobalSearchParamsDTO
from ...types import (
    UNSET,
    File,
    Response,
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/api/leaderboard/v1/proto/leaderboard/entries/global/search/",
    }
...
def sync_detailed(
    *,
    ...
    """Search leaderboard entries across all accessible projects and workspaces
